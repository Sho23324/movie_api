...
class MovieApiApplicationTests {
	...
	void createGenre() {
		...
		assertThat(new_genre_location).isNotNull();
	...
	void updateGenreNotFound() {
		Genre genre = new Genre("Documentary");
		restTemplate.put("/genre/10", genre);
	...
	void deleteGenre() {
		...
		assertThat(response.getStatusCode()).isEqualTo(HttpStatus.OK);
		ResponseEntity<Genre> deleteResponse = restTemplate.exchange("/genres/1", HttpMethod.DELETE, null, Genre.class);
	...
	void deleteCast() {
		...
		assertThat(response.getStatusCode()).isEqualTo(HttpStatus.OK);
		ResponseEntity<Cast> deleteResponse = restTemplate.exchange("/casts/1", HttpMethod.DELETE, null, Cast.class);
		assertThat(deleteResponse.getStatusCode()).isEqualTo(HttpStatus.NO_CONTENT);
	...
	void deleteProduction() {
		...
		assertThat(response.getStatusCode()).isEqualTo(HttpStatus.OK);
		ResponseEntity<Production> deleteResponse = restTemplate.exchange("/productions/1", HttpMethod.DELETE, null, Production.class);
		assertThat(deleteResponse.getStatusCode()).isEqualTo(HttpStatus.NO_CONTENT);
