...
public class ProductionController {
    ...
    public ResponseEntity<Void> createProduction(@RequestBody Production newProduction) {
        Production createdProduction = productionService.createProduction(newProduction);
    ...
    public ResponseEntity<Void> updateProduction(@PathVariable Long productionId, @RequestBody Production newProduction) {
        try {
            productionService.updateProduction(productionId, newProduction);
        } catch (NoSuchElementException e) {
            return ResponseEntity.notFound().build();
        }
